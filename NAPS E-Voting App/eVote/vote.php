	 ...
	 <script type="text/javascript">
		 $(document).ready(function() {
			 $("#verify").click(function(){
				 ...
				 var $fields = ["<?=implode('", "',$votingOrder);?>"];
				 var entry;
			 ...
			 $(".fancybox").fancybox({type : "inline", closeClick: true});
		 });
	 </script>
</head>
<body>
		 ...
		 foreach($votingOrder as $post){
			 ...
			 foreach ($aspirants as $info){//$i = 0;
				// do{
				 ...
				 echo "<p><input type='radio' name='$post' value='$aid' /><span class='vote_icon'><a href='#' title = 'Vote $name as $post'>&emsp;&emsp;</a></span></p>";
				 echo '</div>';
